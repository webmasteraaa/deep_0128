...
<html>
                        ...
                        currentCredit.success(function (data) {
                            if(data != -1) {
                                if(parseFloat(data) >= parseFloat($("#total_price").html())) {
                                    ...
                                    showModal("Your order are confirmed!");
                                }
                            }
                        });
                    }
    ...
    <body onload="fillCart()">
        ...
        <div style=" padding:140px; margin-left: 400px;color:  #f54d56;">
            <marquee><h2>Thanks for Give order and Your order are confirmed! </h2></marquee>
        </div>
        <!-- //check-out -->
        <!-- footer -->
