...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <ul class="nav navbar-right top-nav">
        <li class="dropdown">
            <c:if test="${sessionScope.loggedInUser != null}">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> ${sessionScope.loggedInUser} <b class="caret"></b></a>
            </c:if>
            <c:if test="${sessionScope.loggedInUser == null}">
                <a href="Adminlogin.jsp" ><i class="fa fa-user"></i> Login <b class="caret"></b></a>
            </c:if>
            <ul class="dropdown-menu">
              
                <li class="divider"></li>
                <li>
                    <a href="Adminlogin.jsp"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                </li>
            </ul>
        </li>
    </ul>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse color">
        <ul class="nav navbar-nav side-nav color">
            ...
            <li>
                <a href="showproduct.jsp"><i class="fa fa-fw fa-edit"></i>View / Edit Products</a>
            </li>
            <li>
